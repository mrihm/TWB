<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Text.aspx.cs" Inherits="Chapter_Sample.chapter_4.Text" %>
...
<body>
    <div class="container-fluid">
        <div class="row-fluid">
            ...
            <h4 class="text-center">This is centered heading level 4</h4>
            <h4 class="text-right">This is a right-aligned heading level 4</h4>

            <p class="muted text-center">This line of text has been muted.</p>
            ...
            <p class="text-center text-success">This line of text should serve as a success operation message.</p>
            <p class="text-center text-info">This line of text should serve as an informational message.</p>
        </div>
    </div>
