<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Non-Navigation.aspx.cs" Inherits="Chapter_Sample.chapter_7.version_3._2._0.Non_Navigation" %>
...
<body>
    ...
    <nav class="navbar navbar-default" role="navigation">
        <div class="">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-5">
                <p class="navbar-text navbar-right">Current time <%= DateTime.Now.ToLongTimeString() %> <a href="#" class="navbar-link">Mark Otto</a></p>
                <p class="navbar-text navbar-right">Signed in as <a href="#" class="navbar-link">Mark Otto</a></p>
            </div>
        </div>
    </nav>

    <nav class="no-collapse navbar navbar-default" role="navigation">
    ...
    <div class="navbar navbar-default navbar-inverse" role="navigation" style="min-width: 700px;">
        <div class="container">
            <div class="navbar-header">
